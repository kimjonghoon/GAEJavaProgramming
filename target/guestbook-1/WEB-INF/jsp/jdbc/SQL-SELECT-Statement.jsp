...
<h1 class="heading1">SQL 연습 - SELECT 문</h1>
...
<h3 class="heading3">사원 테이블의 모든 레코드를 조회하시오.</h3>
<pre class="prettyprint">
SELECT * 
FROM EMP
</pre>
...
<h3 class="heading3">사원명과 입사일을 조회하시오.</h3>
<pre class="prettyprint">
SELECT ENAME,HIREDATE
FROM EMP;
</pre>

<h3 class="heading3">사원번호와 이름을 조회하시오.</h3>
<pre class="prettyprint">
SELECT DEPTNO,ENAME 
FROM EMP
</pre>
...
<h3 class="heading3">사원테이블에 있는 직책의 목록을 조회하시오.</h3>
<pre class="prettyprint">
SELECT DISTINCT JOB
FROM
EMP
...
<h3 class="heading3">총 사원수를 구하시오.</h3>
<pre class="prettyprint">
SELECT COUNT(EMPNO)
FROM
EMP
...
<h2 class="heading2">WHERE 조건</h2>
<h3 class="heading3">부서번호가 10인 사원을 조회하시오.</h3>
<pre class="prettyprint">
SELECT * 
FROM EMP
WHERE DEPTNO = 10;
...
<h3 class="heading3">월급여가 2500이상 되는 사원을 조회하시오.</h3>
<pre class="prettyprint">
SELECT *
FROM EMP
WHERE SAL &gt;= 2500;
...
<h3 class="heading3">이름이 'KING'인 사원을 조회하시오.</h3>
<pre class="prettyprint">
SELECT *
FROM EMP
WHERE ENAME = 'KING';
...
<h3 class="heading3">사원들 중 이름이 S로 시작하는 사원의 사원번호와 이름을 조회하시오.</h3>   
<pre class="prettyprint">
SELECT EMPNO,ENAME
FROM EMP
WHERE ENAME LIKE 'S%';
...
<h3 class="heading3">사원 이름에 T가 포함된 사원의 사원번호와 이름을 조회하시오.</h3>
<pre class="prettyprint">
SELECT EMPNO,ENAME
FROM EMP
WHERE ENAME LIKE '%T%';
...
<h3 class="heading3">커미션이 300, 500, 1400 인 사원의 사번,이름,커미션을 조회하시오.</h3>
<pre class="prettyprint">
...
<h3 class="heading3">월급여가 1200 에서 3500 사이의 사원의 사번,이름,월급여를 조회하시오.</h3>
<pre class="prettyprint">
...
<h3 class="heading3">직급이 매니저이고 부서번호가 30번인 사원의  이름,사번,직급,부서번호를 조회하시오.</h3>
<pre class="prettyprint">
...
<h3 class="heading3">부서번호가 30인 아닌 사원의 사번,이름,부서번호를 조회하라.</h3>
<pre class="prettyprint">
...
<h3 class="heading3">커미션이 300, 500, 1400 이 모두 아닌 사원의 사번,이름,커미션을 조회하라.</h3>
<pre class="prettyprint">
SELECT EMPNO,ENAME,COMM
FROM EMP
...
<h3 class="heading3">이름에 S가 포함되지 않는 사원의 사번,이름을 조회하라.</h3>
<pre class="prettyprint">
SELECT EMPNO,ENAME
FROM EMP
...
<h3 class="heading3">급여가 1200보다 미만이거나 3700 초과하는 사원의 사번,이름,월급여를 조회하라.</h3>
<pre class="prettyprint">
SELECT EMPNO,ENAME,SAL
FROM EMP
...
<h3 class="heading3">직속상사가 NULL 인 사원의 이름과 직급을 조회하라.</h3>
<pre class="prettyprint">
SELECT ENAME,JOB
FROM EMP
WHERE MGR IS NULL;
...
<!-- GROUP BY 구문 -->
<h2 class="heading2">GROUP BY 구문</h2>
<pre class="prettyprint">
...
<h3 class="heading3">부서별 평균월급여를 구하는 쿼리</h3>
<pre class="prettyprint">
SELECT DEPTNO,AVG(SAL)
FROM EMP
GROUP BY DEPTNO;
...
<h3 class="heading3">부서별 전체 사원수와 커미션을 받는 사원들의 수를 구하는 쿼리</h3>
<pre class="prettyprint">
...
<h3 class="heading3">부서별 최대 급여와 최소 급여를 구하는 쿼리</h3>
<pre class="prettyprint">
...
<h3 class="heading3">부서별로 월급여 평균을 구하되 나온 결과값이 2000 이상인 것만 구하는 쿼리</h3>
<pre class="prettyprint">
SELECT DEPTNO,AVG(SAL)
FROM EMP
WHERE AVG(SAL) &gt;= 2000;
...
<h3 class="heading3">월급여가 1000 이상인 사원만을 대상으로 부서별로 월급여 평균을 구하라. 단, 평균값이 2000 이상인 레코드만 구하라.</h3>
<pre class="prettyprint">
SELECT DEPTNO,AVG(SAL)
FROM EMP
WHERE SAL &gt;= 1000
...
<!--  ORDER BY 구문 -->
<h2 class="heading2">ORDER BY 구문</h2>
...
<h3 class="heading3">급여가 높은 순으로 조회하되 급여가 같을 경우 이름의 철자가 빠른 사원순으로 사번,이름,월급여를 조회하시오.</h3>
<pre class="prettyprint">
SELECT EMPNO,ENAME,SAL
FROM EMP
...
<h3 class="heading3">사원명과 부서명을 구하는 쿼리</h3>
<pre class="prettyprint">
SELECT ENAME,DNAME
FROM EMP,DEPT
...
<h3 class="heading3">이름,월급여,월급여등급을 조회</h3>
<pre class="prettyprint">
...
<h3 class="heading3">이름,부서명,월급여등급을 조회</h3>
<pre class="prettyprint">
...
<h3 class="heading3">이름,직속상사이름을 조회</h3>
<pre class="prettyprint">
...
<h3 class="heading3">이름,부서명을 조회하라.단, 사원테이블에 부서번호가 40인 사원이 없지만 부서명 OPERATIONS 도 출력되도록 할 것.</h3>
<pre class="prettyprint">
SELECT E.ENAME,D.DNAME
FROM EMP E,DEPT D
WHERE E.DEPTNO(+) = D.DEPTNO;
...
<h3 class="heading3">이름,부서번호,부서이름을 출력</h3>
<pre class="prettyprint">
...
<h3 class="heading3">부서번호가 30번인 사원들의 이름, 직급, 부서번호, 부서위치</h3>
<pre class="prettyprint">
...
<h3 class="heading3">커미션을 받는 사원의 이름, 커미션, 부서이름,부서위치</h3>
<pre class="prettyprint">
...
<h3 class="heading3">DALLAS 에서 근무하는 사원의 이름,직급,부서번호,부서명</h3>
<pre class="prettyprint">
...
<h3 class="heading3">이름에 A 가 들어가는 사원들의 이름,부서명</h3>
<pre class="prettyprint">
SELECT E.ENAME,D.DNAME
FROM EMP E,DEPT D
WHERE E.DEPTNO = D.DEPTNO
...
<h3 class="heading3">이름, 직급, 월급여, 월급여등급</h3>
<pre class="prettyprint">
...
<h3 class="heading3">ALLEN 과 같은 부서에 근무하는 사원의 이름, 부서번호</h3>
<pre class="prettyprint">
...
<h3 class="heading3">10번 부서에서 근무하는 사원의 이름과 10번 부서의 부서명</h3>
<pre class="prettyprint">
SELECT E.ENAME,D.DNAME
FROM EMP E,DEPT D
WHERE E.DEPTNO = D.DEPTNO
...
<h3 class="heading3">평균 월급여보다 더 많은 월급여를 받은 사원의 사원번호,이름,월급여 조회</h3>
<pre class="prettyprint">
SELECT EMPNO,ENAME,SAL
FROM EMP
...
<h3 class="heading3">부서번호가 10인 사원중에서 최대급여를 받는 사원과 동일한 급여를 받는 사원의 사원번호, 이름 조회</h3>
<pre class="prettyprint">
SELECT EMPNO,ENAME
FROM EMP
