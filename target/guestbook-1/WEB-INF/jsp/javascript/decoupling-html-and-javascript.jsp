...
<h1 class="heading1">HTML과 자바스크립트의 분리</h1>

<h2 class="heading2">DOM 실습을 위한 준비 작업</h2>
...
<h3 class="heading3">design.war 파일에 대한 설명</h3>
...
<h2 class="heading2">다운로드/파일삭제 링크에서 스크립트 분리</h2>
...
<h2 class="heading2">댓글(수정|삭제, 수정하기|취소)링크에서 스크립트 분리</h2>
...
<h2 class="heading2">다음글, 이전글 링크에서 스크립트 분리</h2>
...
<h2 class="heading2">수정,삭제,다음글,이전글,목록,새글쓰기 버튼에서 스크립트 분리</h2>
...
<h2 class="heading2">목록링크/페이징 처리/새글쓰기 버튼에서 스크립트 분리</h2>
...
<h2 class="heading2">다운로드/파일 삭제 링크에서 스크립트 분리(jQuery)</h2>
...
<h2 class="heading2">댓글(수정/삭제, 수정하기/취소)링크에서 스크립트 분리(jQuery)</h2>
...
<h2 class="heading2">이전글, 다음글 링크에서 스크립트 분리(jQuery)</h2>
...
<h2 class="heading2">수정, 삭제, 다음글, 이전글, 목록, 새글쓰기 버튼에서 스크립트 분리(jQuery)</h2>
...
<h2 class="heading2">목록링크/페이징 처리/새글쓰기 버튼에서 스크립트 분리(jQuery)</h2>
