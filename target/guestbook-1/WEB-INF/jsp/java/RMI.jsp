...
<h2 class="heading2">RMI 프로그래밍 방법</h2>
<ol>
	<li>원격 인터페이스를 정의</li>
	<li>서버 구현</li>
	<li>클라이언트 구현</li>
...
<h3 class="heading3">1. 원격 인터페이스 정의 - Hello.java</h3>
...
<h3 class="heading3">2. 서버 구현 - Server.java</h3>
...
<h3 class="heading3">3. 클라이언트 구현</h3>
...
<h2 class="heading2">4. 테스트</h2>

<h3 class="heading3">윈도</h3>
...
<h3 class="heading3">컴퓨터가 2대 이상에서 테스트</h3>
