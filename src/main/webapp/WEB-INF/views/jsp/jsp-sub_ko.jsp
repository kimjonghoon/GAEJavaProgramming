...
<nav id="secondaryNav">
	...
	<ul id="sub-menu">
		...
		<li class="sub-menu-item"><a href="/jsp/BBS-Study">게시판 연구</a></li>
		<li class="sub-menu-item"><a href="/jsp/Thread-BBS">계층형 게시판</a></li>
		<li class="sub-menu-item"><a href="/jsp/BBS-Model1">모델 1 게시판</a></li>
		<li class="sub-menu-item"><a href="/jsp/DataSource">DataSource</a></li>
		<li class="sub-menu-item"><a href="/jsp/Model2">모델 2 게시판</a></li>
