...
<h1 class="heading1">자바스크립트 소개</h1>
...
<h3 class="heading3">자바스크립트의 쓰임새</h3>
<ol>
...
<h3 class="heading3">1. 사용자가 입력한 값이 유효한지 검사</h3>
...
<h3 class="heading3">2. 이벤트 핸들러(엘리먼트에서 이벤트가 발생하면 동작하는 함수) 작성</h3>
...
<h3 class="heading3">3. 드롭 다운 메뉴와 같은 동적인 메뉴 생성</h3>
...
<h3 class="heading3">4. 엘리먼트에 적용된 CSS 속성을 동적으로 변경</h3>
...
<h3 class="heading3">5. 웹 페이지 내용을 추가</h3>
