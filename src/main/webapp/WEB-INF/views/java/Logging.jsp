...
<article>
<div class="last-modified">Last Modified 2017.2.8</div>
...
Copy log4j-api-2.8.jar and log4j-core-2.8.jar from the directory where you extracted the file and paste them into the path that the class loader can find.
The following property file is created in the path that the class loader can find.
</p>

<em class="filename">log42.xml</em>
<pre class="prettyprint">
...
<ol>
	...
	<li>Add the Log4j 2 library to the project's Build Path.
		<ol>
			...
			<li>Add log4j-api-2.8.jar and log4j-core-2.8.jar and click the OK button.</li> 
		</ol>
...
<h2>Commons Logging with Log4j 2</h2>
...
After unpacking, add the slf4j-api-1.7.22.jar and slf4j-simple-1.7.22.jar files to the classpath.<br />
...
<p>
Add the slf4j-api-1.7.22.jar and slf4j-simple-1.7.22.jar files to the Javabank classpath.<br />
...
Add logback-core-1.2.0.jar, logback-classic-1.2.0.jar, and logback-access-1.2.0.jar to the classpath.<br />
Remove slf4-simple-1.7-22.jar from the classpath.<br />
</p>
