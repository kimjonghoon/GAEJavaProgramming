...
<em class="filename">Adding a constructor to Employee class</em>
<pre class="prettyprint">
...
<em class="filename">Adding a constructor to Manager class</em>
<pre class="prettyprint">
...
<em class="filename">Modify the main method of the Test class</em>
<pre class="prettyprint">
...
<em class="filename">Code that the compiler added in Employee's Contructor</em>
<pre class="prettyprint">
public Employee() {
	<strong>super();</strong>
}
...
<em class="filename">Code that the compiler added in Manager's Contructor</em>
<pre class="prettyprint">
public Manager() {
	<strong>super();</strong>
}
...
<em class="filename">Add the following code to the main method of Test.java</em>
<pre class="prettyprint">
