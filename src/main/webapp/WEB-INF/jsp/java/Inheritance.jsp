...
<h2 class="heading2">생성자(Constructor)</h2>
...
<h2 class="heading2">부모 타입의 참조형 변수에 자식 타입의 참조값을 할당할 수 있다.</h2>
...
<h2 class="heading2">final 키워드</h2>
<ol>
...
<h2 class="heading2">추상클래스(Abstract Class)</h2>
...
<h2 class="heading2">인터페이스(interface): 컴포넌트<a href="#comments"><sup>7</sup></a>의 기능을 정의한다.</h2>
...
<h3 class="heading3">언제 인터페이스를 사용해야 하나?</h3>
