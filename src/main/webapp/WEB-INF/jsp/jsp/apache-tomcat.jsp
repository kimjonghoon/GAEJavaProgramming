...
<h3 class="heading3">1. Apache 설치</h3>
<p>
...
<h5 class="heading5">(1) Server Information</h5>
<p>
...
<h5 class="heading5">(2) Setup Type</h5>
<p>
...
<h5 class="heading5">(3) Custom Setup</h5>
<p>
...
<h5 class="heading5">(3)-1 Change Current Destination Folder</h5>
<p>
...
<h5 class="heading5">(4) Installing Apache HTTP Server</h5>
<p>
설치가 진행됩니다<br />
...
<h5 class="heading5">(6) 작업 디렉토리 생성 및 DocumentRoot 변경</h5>
<p>
...
<h4 class="heading4">httpd.conf</h4>
<pre>
.. 
228줄
...
<h5 class="heading5">(4) Choose Install Location</h5>
<p>
...
<h5 class="heading5">(4)-1 설치 디렉토리 찾기 </h5>
<p>
...
<h5 class="heading5">(4)-2 설치 디렉토리 확인 </h5>
<p>
...
<h5 class="heading5">(5) Configuration </h5>
<p>
...
<h3 class="heading3">(6) Java Virtual Machine path select</h3>
<p>
...
<h5 class="heading5">(9) Tomcat Startup</h5>
<p>
...
<h5 class="heading5">(10) Tomcat Monitor</h5>
<p>
...
<h5 class="heading5">(11) Tomcat Properties</h5>
<p>
...
<h3 class="heading3">3. Apache Tomcat 연동</h3>
<h5 class="heading5">(1) ROOT 애플리케이션 변경</h5>
<p>
...
<h5 class="heading5">(2) mod_jk2.so 복사</h5>
<p>
...
<h5 class="heading5">(3) httpd.conf 파일 편집</h5>
<p>
...
<h5 class="heading5">(4) workers.properties 생성</h5>
<p>
C:\apps\Apache2\conf 디렉토리 안에 workers.properties 파일을 아래와 같이 생성합니다.
</p>
<h4 class="heading4">workers.properties</h4>			
<pre>worker.list=tomcat1
worker.tomcat1.port=8009
worker.tomcat1.host=localhost
worker.tomcat1.type=ajp13
</pre>
<h5 class="heading5">(5) 연동 테스트</h5>
<p>
